    ...
    <div className="max-w-4xl mx-auto px-6 pt-6 pb-28 space-y-8">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 text-sm border border-[#E5E5E5] bg-white focus:border-black focus:outline-hidden"
        />
      </div>
      ...
      {loading ? (
        ...
        <div className="py-20 text-center border border-[#E5E5E5] bg-white space-y-3">
        ...
        <div className="space-y-4">
          {articles.map((art) => (
            <div
              ...
              className="p-4 sm:p-5 border border-[#E5E5E5] bg-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:border-black/40 transition-colors"
            >
